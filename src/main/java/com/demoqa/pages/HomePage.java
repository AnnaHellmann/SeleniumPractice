...
import com.demoqa.pages.alerts_frames_windows.AlertsFrameWindowsPage;
...
public class HomePage extends BasePage {
    ...
    private By alertsFrameWindowswCard = By.xpath("//h5[text()='Alerts, Frame & Windows']");
    ...
    public AlertsFrameWindowsPage goToAlertsFrameWindows(){
        scrollToElementJS(alertsFrameWindowswCard);
        click(alertsFrameWindowswCard);
